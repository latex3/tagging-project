...
\title{Simple template with order key}
...
\DeclareInstance{threeargs}{default}{trial}{
  % no parameter settings, just use what the template has default values
}
...
% A bit of tracing (you find the output in the .log file):
