...
\DeclareDocumentCommand \part {s ={shorttitle}o m}
      {\par\ParseLaTeXeHeading {part} {#1} {#2} {#3}}
\DeclareDocumentCommand \chapter {s ={shorttitle}o m}
     {\par\ParseLaTeXeHeading {chapter}{\BooleanTrue} {#2} {#3}}
...
\hyphenation{hypocr-is-ies meshel-em-iah philis-tines}
...
\DeclareDocumentCommand{\bookchapter}{om}{
  ...
  \AssignStructureRole{para/textblock}{verse}
  \AssignStructureRole{para/semantic}{Chapter}
  % Separate chapters with a bit of space
  \vspace{2ex plus 2ex minus .2ex}

  % Fancy chapter numbers
  \begingroup
   \AssignStructureRole{para/textblock}{Chapter-Title} 
   \noindent
...
\AssignStructureRole{sec/0}{Frontmatter}
\AssignStructureRole{sec/0/title}{Frontmatter-Title}

\AddToHook{cmd/mainmatter/before}
 {\AssignStructureRole{sec/0}{Book}
  \AssignStructureRole{sec/0/title}{Book-Title}}
 \AssignStructureRole{sec/-1}{Testament}
 \AssignStructureRole{sec/-1/title}{Testament-Title}
