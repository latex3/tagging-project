...
%
% 	This version of the test file uses the [grid] and [lineno] options
%
...
\documentclass[captionpatch,grid,lineno,colorlinks,upint,subscriptcorrection,varvw,mathalfa=cal=boondoxo,german]{asmeconf}
