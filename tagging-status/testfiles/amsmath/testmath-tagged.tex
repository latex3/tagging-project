% adapted from testmath.tex
% Changes from original file:
%   1. Convert all P_\X to P_{\X} (for unicode-math)
%   2. Comment out redefinition of \@makecol
%   3. Until new luamml is released, comment out smallmatrix envs (#875)
\DocumentMetadata
  {
    lang=en-US,
    pdfversion=2.0,
    pdfstandard=ua-2,
    tagging=on,
%    tagging-setup={math/setup=mathml-SE}, % produces parent-kid warnings
  }
...
D(t_1,\dots,t_n)}_{t_i=
%\left\{\begin{smallmatrix}
%0,& \text{if }i\in I_{l}\quad\\% \quad added for centering
%1,& \text{otherwise}\end{smallmatrix}\right.
\;,\;\; i=1,\dots,n}.
\end{equation}
\end{prop}
